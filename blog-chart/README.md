...
```bash
$ helm repo add davidyou_go https://github.com/DavidYou21st/charts.git
$ helm install my-release davidyou_go/blog-chart
```

## Introduction

blog-chart 参考 Bitnami 作为一个通用模板，可用于新 chart 的快速制作，仅需将 app-name 名字替换下即可。

This chart bootstraps a [blog-chart Open Source](https://github.com/bitnami/bitnami-docker-nginx) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
$ helm install my-release ygqygq2/blog-chart
```
...
### blog-chart parameters

| Name                 | Description                                                                                           | Value                 |
| -------------------- | ----------------------------------------------------------------------------------------------------- | --------------------- |
| `image.registry`     | blog-chart image registry                                                                              | `docker.io`           |
| `image.repository`   | blog-chart image repository                                                                            | `bitnami/nginx`       |
| `image.tag`          | blog-chart image tag (immutable tags are recommended)                                                  | `latest`              |
| `image.digest`       | Image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag       | `""`                  |
| `image.pullPolicy`   | blog-chart image pull policy                                                                           | `IfNotPresent`        |
| `image.pullSecrets`  | Specify docker-registry secret names as an array                                                      | `[]`                  |
| `image.debug`        | Set to true if you would like to see extra information on logs                                        | `false`               |
| `hostAliases`        | Deployment pod host aliases                                                                           | `[]`                  |
| `command`            | Override default container command (useful when using custom images)                                  | `[]`                  |
| `args`               | Override default container args (useful when using custom images)                                     | `[]`                  |
| `extraEnvVars`       | Extra environment variables to be set on blog-chart containers                                         | `[]`                  |
| `extraEnvVarsCM`     | Name of existing ConfigMap containing extra environment variables                                     | `""`                  |
| `extraEnvVarsSecret` | Name of existing Secret containing extra environment variables                                        | `""`                  |


### blog-chart deployment parameters

| Name                                    | Description                                                                               | Value   |
| --------------------------------------- | ----------------------------------------------------------------------------------------- | ------- |
| `replicaCount`                          | Number of blog-chart replicas to deploy                                                    | `1`     |
| `podLabels`                             | Additional labels for blog-chart pods                                                      | `{}`    |
| `podAnnotations`                        | Annotations for blog-chart pods                                                            | `{}`    |
...
| `podSecurityContext.enabled`            | Enabled blog-chart pods' Security Context                                                  | `false` |
| `podSecurityContext.fsGroup`            | Set blog-chart pod's Security Context fsGroup                                              | `1001`  |
| `podSecurityContext.sysctls`            | sysctl settings of the blog-chart pods                                                     | `[]`    |
| `containerSecurityContext.enabled`      | Enabled blog-chart containers' Security Context                                            | `false` |
| `containerSecurityContext.runAsUser`    | Set blog-chart container's Security Context runAsUser                                      | `1001`  |
| `containerSecurityContext.runAsNonRoot` | Set blog-chart container's Security Context runAsNonRoot                                   | `true`  |
| `containerPorts.http`                   | Sets http port inside blog-chart container                                                 | `8080`  |
| `containerPorts.https`                  | Sets https port inside blog-chart container                                                | `""`    |
| `resources.limits`                      | The resources limits for the blog-chart container                                          | `{}`    |
| `resources.requests`                    | The requested resources for the blog-chart container                                       | `{}`    |
| `customLivenessProbe`                   | Override default liveness probe                                                           | `{}`    |
| `customReadinessProbe`                  | Override default readiness probe                                                          | `{}`    |
| `healthCheck`                           | 简化的健康检测，支持 tcp、http，具体查看 `values.yaml`                                    |         |
| `autoscaling.enabled`                   | Enable autoscaling for blog-chart deployment                                               | `false` |
...
| `metrics.port`                             | blog-chart Container Status Port scraped by Prometheus Exporter                                                                                | `""`                     |
| `metrics.image.registry`                   | blog-chart Prometheus exporter image registry                                                                                                  | `docker.io`              |
| `metrics.image.repository`                 | blog-chart Prometheus exporter image repository                                                                                                | `bitnami/nginx-exporter` |
| `metrics.image.tag`                        | blog-chart Prometheus exporter image tag (immutable tags are recommended)                                                                      | `0.10.0-debian-10-r8`    |
| `metrics.image.pullPolicy`                 | blog-chart Prometheus exporter image pull policy                                                                                               | `IfNotPresent`           |
| `metrics.image.pullSecrets`                | Specify docker-registry secret names as an array                                                                                          | `[]`                     |
| `metrics.podAnnotations`                   | Additional annotations for blog-chart Prometheus exporter pod(s)                                                                               | `{}`                     |
| `metrics.securityContext.enabled`          | Enabled blog-chart Exporter containers' Security Context                                                                                       | `false`                  |
| `metrics.securityContext.runAsUser`        | Set blog-chart Exporter container's Security Context runAsUser                                                                                 | `1001`                   |
| `metrics.service.port`                     | blog-chart Prometheus exporter service port                                                                                                    | `9113`                   |
| `metrics.service.annotations`              | Annotations for the Prometheus exporter service                                                                                           | `{}`                     |
| `metrics.resources.limits`                 | The resources limits for the blog-chart Prometheus exporter container                                                                          | `{}`                     |
| `metrics.resources.requests`               | The requested resources for the blog-chart Prometheus exporter container                                                                       | `{}`                     |
...
```bash
$ helm install my-release -f values.yaml ygqygq2/blog-chart
```
...
### Use a different blog-chart version
...
Most likely you will only want to have one hostname that maps to this blog-chart installation. If that's your case, the property `ingress.hostname` will set it. However, it is possible to have more than one host. To facilitate this, the `ingress.extraHosts` object can be specified as an array. You can also use `ingress.extraTLS` to add the TLS configuration for extra hosts.
